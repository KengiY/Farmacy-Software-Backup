 ...
 * @author 39329
 */
public class NotificheDipendente extends javax.swing.JFrame {
    ...
    public NotificheDipendente() throws SQLException {
        initComponents();
        carica_tabella();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificheDipendente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(NotificheDipendente.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
