 ...
 * @author 39329
 */
public class NotificheFarmacista extends javax.swing.JFrame {
    ...
    public NotificheFarmacista() throws SQLException {
        initComponents();
        carica_tabella();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotificheFarmacista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    Logger.getLogger(NotificheFarmacista.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
